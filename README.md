...
> Professional JavaScript-Weather-API - Created by Gabriel Demetrios Lafis
...
**Javascript Weather Api** is a production-grade JavaScript application that showcases modern software engineering practices including clean architecture, comprehensive testing, containerized deployment, and CI/CD readiness.
...
git clone https://github.com/galafis/JavaScript-Weather-API.git
cd JavaScript-Weather-API
...
**Javascript Weather Api** é uma aplicação JavaScript de nível profissional que demonstra práticas modernas de engenharia de software, incluindo arquitetura limpa, testes abrangentes, implantação containerizada e prontidão para CI/CD.
